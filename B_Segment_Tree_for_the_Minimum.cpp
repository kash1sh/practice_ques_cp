...
// segtree<my_node, my_update> t;
int arr[N];
int main()
{

    segtree<my_node, my_update> s(100002); // create a segment tree of length 1000
    // vector<int> v(1000);
